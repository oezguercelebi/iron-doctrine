...
- [ ] integration · idle-review · lane hubs on main · after art,sim,client · Runtime, manifests, shared contracts/data, launch/build, visible match and gates.
...
- [ ] sim-r1 · done · lane src/Sim/**, tests/** · after sim · Five independent R edge cases with regressions.
...
- [ ] sim-r2 · idle-review · lane src/Sim/**, tests/** · after sim-r1 · Sanitize point orders, queue unload correctly, clear control on capture.
